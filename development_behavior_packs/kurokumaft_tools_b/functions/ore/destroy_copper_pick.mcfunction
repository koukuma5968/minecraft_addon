execute @s[tag=destroy_copper_pick] ~~~ detect ^0 ^1 ^1 copper_ore 0 setblock ^0 ^1 ^1 copper_ore 0 destroy
execute @s[tag=destroy_copper_pick] ~~~ detect ^0 ^1 ^2 copper_ore 0 setblock ^0 ^1 ^2 copper_ore 0 destroy
execute @s[tag=destroy_copper_pick] ~~~ detect ^0 ^1 ^1 deepslate_copper_ore 0 setblock ^0 ^1 ^1 deepslate_copper_ore 0 destroy
execute @s[tag=destroy_copper_pick] ~~~ detect ^0 ^1 ^2 deepslate_copper_ore 0 setblock ^0 ^1 ^2 deepslate_copper_ore 0 destroy
execute @s[tag=destroy_copper_pick] ~~~ detect ^0 ^1 ^1 copper_block 0 setblock ^0 ^1 ^1 copper_block 0 destroy
