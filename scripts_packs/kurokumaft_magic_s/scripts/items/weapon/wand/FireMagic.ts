import { Entity, EntityComponentTypes, EntityDamageCause, EntityProjectileComponent, EntityQueryOptions, EntityRideableComponent, EntityTameableComponent, EntityTameMountComponent, EntityTypeFamilyComponent, MolangVariableMap, Player, system, System, TicksPerSecond } from "@minecraft/server";
 ...
 * バーストクラッシュ
 */
export async function burstCrash(player:Player, hitEntity:Entity) {
 ...
 * ラピッドファイア
 */
export async function rapidFire(entity:Entity, projectileName:string) {
 ...
 * ファイアバリア
 */
export async function firebarrier(player:Player) {
