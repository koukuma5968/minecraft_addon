 ...
 * ストーンダスト
 */
export async function stonedust(player:Player, hitEntity:Entity) {
 ...
 * ストーンバラージ
 */
export async function stonebarrage(entity:Entity, projectileName:string) {
 ...
 * ストーンバリア
 */
export async function stonebarrier(player:Player) {
