 ...
 * ドレットスパーク
 */
export async function dreadspark(player:Player, hitEntity:Entity) {
 ...
 * ライトニングラッシュ
 */
export async function lightningrush(entity:Entity, projectileName:string) {
 ...
 * ライトニングバリア
 */
export async function lightningbarrier(player:Player) {
