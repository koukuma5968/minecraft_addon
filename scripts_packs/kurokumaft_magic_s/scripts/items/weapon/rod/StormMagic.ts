import { Entity, EntityComponentTypes, EntityDamageCause, EntityProjectileComponent, EntityQueryOptions, Player, system, TicksPerSecond, world } from "@minecraft/server";
